...
%        items_read_test(result_index,:)', items_clicked_test(result_index,:)' ];
    ...
    state1=[inital_state;focus;current_item_query_words;...
        current_item_title_length;already_clicked]';
...
%              ImmediateReward=Reward(1,1)*ResultListRelevance(focus);
       ...
       %mark wheather you have already clicked an item or not
       already_clicked = items_clicked(1,focus);
...
%         available_query_words(opened) = query_words_read(opened);
        ...
        state1=[temp1,focus,available_query_words,...
            available_title_length,already_clicked];
       ...
       ImmediateReward= ImmediateReward - Duration;
        ...
        QT(state_row,action_chosen) + ...
        alpha*( ImmediateReward + gamma  *   max(QT(new_state_row,:)) - QT(state_row,action_chosen) ); 
